...
import com.ycw.common.context.DynamicDataSourceContextHolder;
import com.ycw.common.enums.DataSourcesType;
import com.ycw.datasource.aspect.DynamicDataSourceAspect;
import lombok.Data;
...
public class DruidDataSourceConfig {
    ...
    @ConditionalOnProperty(prefix = "spring.datasource.druid.sys", name = "enable", havingValue = "true")
    ...
    @Primary
    public DynamicDataSource dynamicDataSource(@Qualifier("appDataSource") DataSource appDataSource, @Qualifier("sysDataSource") DataSource sysDataSource) {
        DynamicDataSource dynamicDataSource = new DynamicDataSource();
        dynamicDataSource.addDataSource(DataSourcesType.APP, appDataSource);
        dynamicDataSource.addDataSource(DataSourcesType.SYS, sysDataSource);
